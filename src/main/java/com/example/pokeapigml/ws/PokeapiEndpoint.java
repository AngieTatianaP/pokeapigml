package com.example.pokeapigml.ws;

import com.example.pokeapigml.client.entity.Ability;
import com.example.pokeapigml.client.PokeAPIClient;
import com.example.pokeapigml.client.entity.PokemonResponse;
import dev.angietatianap.pokeapi.*;
...
public class PokeapiEndpoint {
    ...
    private static final String NAMESPACE_URI = "http://angietatianap.dev/pokeapi";
    ...
    public GetPokemonResponse getPokemon(@RequestPayload GetPokemonRequest request) {
        ...
        if(pokemonResponse == null)
            ...
            for (com.example.pokeapigml.client.entity.Held held : pokemonResponse.getHeldItems()) {
                Held h = new Held();
                HeldItem heldItem = new HeldItem();
                heldItem.setName(held.getItem().getName());
                heldItem.setUrl(held.getItem().getUrl());
                h.setItem(heldItem);
                for (com.example.pokeapigml.client.entity.VersionDetail version : held.getVersionDetails()) {
            ...
            for (Ability ability : pokemonResponse.getAbilities()) {
                dev.angietatianap.pokeapi.Ability a = new dev.angietatianap.pokeapi.Ability();
